  ...
  class Practice extends JPanel {
    ...
    class GamePanelLevel2 extends JPanel {
      ...
      public void paintComponent(Graphics g) {
        ...
        for (int w=0; w<xp.length; w++) {
          if (xp[w] !=0) {
            g.drawImage(lazerball_bullet, xp[w]/(1*speed), yp[w], 35,25, null);
        ...
        for (int w=0; w<xp2.length; w++) {
          if (xp2[w] !=0) {
            g.drawImage(lazerball_bullet, (72000-xp2[w])/(1*speed), yp2[w], 35,25, null);
        ...
        if (key == 's') {
          if (key_flag == true) {
            ...
            for(int i=0; i<xp.length; i++) {
              if (xp[i] == 0) {
                xp[i] = 40000;  //Height of ball (original: 900)
        ...
        if (key == 'a') {
          if (key_flag == true) {
            ...
            for(int i=0; i<xp2.length; i++) {
              if (xp2[i] == 0) {
                xp2[i] = 44000;  //Height of ball (original: 900)
