...
public class Patriots extends JFrame {
  ...
  class Practice extends JPanel {
    ...
    public void mainMenu() {
      ...
      JButton secondlevelBtn = new JButton("Next");
      secondlevelBtn.addActionListener(new sbuttonListener());
      gp2.add(secondlevelBtn);
      add(gp2, "Game Panel 2");

      //JButton secondlevelBtn2 = new JButton("Level2");
      //level2.add(secondlevelBtn2);
      add(level2, "Level2");

      Toolkit toolkit = Toolkit.getDefaultToolkit();
      Image image = toolkit.getImage("cursor.png"); //Source: https://www.vecteezy.com/png/1199094-gun
    ...
    class GamePanel extends JPanel {
      ...
      public int get_robot_height(int height) {
        ...
        if (height > 430 && delta < 5000 + (int)(Math.random()*10000)) {
    ...
    class GamePanelLevel2 extends JPanel {
      int x=0;
      int x2=0;
      Image leve2background;
      Image ufo;
      Image ufo2;
      Instant start_time = Instant.now();

      GamePanelLevel2() {
        leve2background = new ImageIcon("peepo.gif").getImage();
      ...
      public void paintComponent(Graphics g) {
       ...
       if ((int)Duration.between(start_time, Instant.now()).getSeconds() <1) {
        ...
        JLabel winHeader = new JLabel("<html>" + "YOU WON LEVEL 1" + "<br>" + "</html>");
        winHeader.setFont(new Font("BaccaratUprightWide", Font.BOLD, 55)); 
        winHeader.setHorizontalAlignment(JLabel.CENTER);
        add(winHeader);
        JButton next = new JButton("NEXT LEVEL");
        ...
        g.drawImage(leve2background, x, 500, 100,100, null);
        repaint();
    ...
    class sbuttonListener implements ActionListener {
      ...
      public void actionPerformed(ActionEvent e) {
        ...
        if(sbutton.equalsIgnoreCase("Play")) {
          ...
          pc.cardLayout1.show(pc, "Game Panel 2");
        } else if(sbutton.equalsIgnoreCase("Next")) {
