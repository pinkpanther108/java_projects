...
class Panel extends JPanel {
   ...
   */
    ...
    public void draw(Graphics g, String answer) {
      Image allen = new ImageIcon("Allen_Iverson.png").getImage();
      for (int i=0; i<answer.length();i++) {
        if ((int)answer.charAt(i)==48) zero(g, i);
        if ((int)answer.charAt(i)==49) one(g, i);
        if ((int)answer.charAt(i)==48) two(g, i);
        if ((int)answer.charAt(i)==48) three(g, i);
        if ((int)answer.charAt(i)==48) four(g, i);
        if ((int)answer.charAt(i)==48) five(g, i);
        if ((int)answer.charAt(i)==48) six(g, i);
        if ((int)answer.charAt(i)==48) seven(g, i);
        if ((int)answer.charAt(i)==48) eight(g, i);
        if ((int)answer.charAt(i)==48) nine(g, i);
        if ((int)answer.charAt(i)==48) charA(g, i);
        if ((int)answer.charAt(i)==48) charB(g, i);
        if ((int)answer.charAt(i)==48) charC(g, i);
        if ((int)answer.charAt(i)==48) charD(g, i);
        if ((int)answer.charAt(i)==48) charE(g, i);
        if ((int)answer.charAt(i)==48) charF(g, i);
      }
    }
