...
class Practice extends JPanel
{
  ...
  public void runIt()
  {
    ...
    JButton ba2 = new JButton("<html>" + "Science" + "<br>" +num2+ "</html>");
  ...
  class clickHandle implements ActionListener
  {
    ...
    public void actionPerformed(ActionEvent e)
    {
      ...
      if ( commandClick.equals ("Science") )
      {
        pressedScience = true;
        num2++;
      }
