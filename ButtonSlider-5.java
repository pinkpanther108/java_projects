...
class Practice extends JPanel
{
  ...
  int countCommand1 = 0;
  //int countCommand = 0;
  private JButton ba1, ba2, ba3, ba4;
  int mathcount = 0;
  int sciencecount = 0;
  int javacount = 0;
  int totalNum = 0;
  ...
  public void runIt()
  {
    //System.out.println("Science matched " + sciencecount);
    ba1 = new JButton("Reset");
  ...
  class clickHandle implements ActionListener
  {
    ...
    public void actionPerformed(ActionEvent e)
    {
      ...
      if (commandClick.indexOf("Math") != -1) {
        mathcount++;
        System.out.println("MATH matched " + mathcount);
        ba4.setText("<html>" + "Math" + "<br>" +mathcount+ "</html>");
      }
      if (commandClick.indexOf("Java") != -1) {
        javacount++;
        System.out.println("java matched " + javacount);
        ba3.setText("<html>" + "Java" + "<br>" +javacount+ "</html>");
      }
      if (commandClick.indexOf("Science") != -1) {
        sciencecount++;
        System.out.println("Science matched " + sciencecount);
        ba2.setText("<html>" + "Science" + "<br>" +sciencecount+ "</html>");
      }
      totalNum = sciencecount + javacount + mathcount;
      ...
      System.out.println("Reset matched " + totalNum);
      ba1.setText("<html>" + "Total Time: " + "<br>" +totalNum+ " hrs" + "</html>");
