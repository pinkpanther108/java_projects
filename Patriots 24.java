...
public class Patriots extends JFrame {
  ...
  class Practice extends JPanel {
    ...
    class mainPanel extends JPanel {
      ...
      Icon design2;
      mainPanel() {
        startPageBackground = new ImageIcon("galaxy.gif").getImage(); //Source: //Source: https://giphy.com/gifs/trippy-weird-psychedelic-3ov9k1173PdfJWRsoE
        design2 = new ImageIcon("greenDesign.png"); //Source: 
        setLayout(null);
    ...
    class GamePanel extends JPanel {
      int speed = 3;
      JButton secondlevel = new JButton("Level2.2");
      Image soldier1reg;
      ...
      public boolean turn_on_robot_shield() {
        if ((int)Duration.between(robot_shield_time, Instant.now()).getSeconds() > 5) {
          if ((int)Duration.between(robot_shield_time, Instant.now()).getSeconds() > 7) {
    ...
    class GamePanelLevel2 extends JPanel {
      ...
      GamePanelLevel2() {
        ...
        level2Background = new ImageIcon("shootingStars.gif").getImage(); //Source: https://web-design.lovetoknow.com/Animated_Shooting_Stars
        soldier1og = new ImageIcon("soldier1og.png").getImage();
      }
      //Graphics for the second level's panel
      public void paintComponent(Graphics g) {
        ...
        //Source: //Source: https://giphy.com/gifs/trippy-weird-psychedelic-3ov9k1173PdfJWRsoE
        if (x2 < 300) {
        ...
        g.drawImage(enemy, x, 500, 50,50, null);
        repaint();
    ...
    class Instructions extends JPanel {
      ...
      Instructions() { 
        ...
        previousButton.addMouseListener(new MouseAdapter() {
          Color color = previousButton.getForeground();
          //When mouse enters, the button changes color
          public void mouseEntered(MouseEvent e) {
            //previousButton.setOpaque(true);
            color = previousButton.getForeground();
            previousButton.setForeground(new Color(204,0,0)); 
            previousButton.setBounds(300, 200, 300, 100);
            //previousButton.setBackground(new Color(217,217,214));
